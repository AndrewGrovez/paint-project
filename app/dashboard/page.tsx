    ...
    try {
      ...
      setProducts(prevProducts =>
        prevProducts.map(product => {
          const sbItem = supabaseData?.find((item: SupabaseProductData) => item.id === product.id)
          ...
          {filteredProducts.map((product) => (
            ...
            >
              <div className="p-6">
                ...
                <div className="aspect-w-1 aspect-h-1 overflow-hidden rounded-lg bg-white mb-4 flex items-center justify-center">
                  <Image
